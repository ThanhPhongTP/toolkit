...
export const TOOLS: ToolDefinition[] = [
  ...
  {
    id: 'mobile-terminal',
    title: 'Mobile Terminal Commands',
    description: 'Terminal commands to run, build, and debug React Native, Flutter, Android, and iOS apps.',
    category: 'dev-utils',
    keywords: [
      'mobile',
      'terminal',
    ...
    icon: Smartphone,
    component: lazy(() =>
      import('./mobile-terminal/MobileTerminalTool').then((m) => ({ default: m.MobileTerminalTool })),
    ),
  },
  {
    id: 'csv-json',
  ...
  },
  {
    ...
    description: 'Convert colors between hex, RGB, HSL, HSV, iOS (UIKit/SwiftUI), and Android (Compose/XML).',
    category: 'converters',
    keywords: [
      'color',
      'hex',
